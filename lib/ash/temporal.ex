...
defmodule Ash.Temporal do
  ...
  `:now` resolves to the current instant; `nil` is unset and stays so. A range answers
  the point its portion begins at, and one with no lower bound names none.
  """
  ...
  A range names the period outright; an instant opens one at itself: `[instant, ∞)`.
  """
