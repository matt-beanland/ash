...
defmodule Ash.Query do
  ...
  # as a concrete value. A `DateTime` fixes the instant; `nil` means unset. A range resolves
  # to its lower bound, where the portion it names begins; an unbounded lower names none.
